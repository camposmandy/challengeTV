...
class NivelTresViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if nomeCategoria == "Animais"{
            ...
            opcoesCarta = ["Banana.png", "Cereja.png", "Coco.png", "Laranja.png", "Limao.png", "Maca.png", "Melancia.png", "Banana.png", "Cereja.png", "Coco.png", "Laranja.png", "Limao.png", "Maca.png", "Melancia.png"]
        } else {
            opcoesCarta = ["1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "1-1.png", "2-1.png", "3-1.png", "4-1.png", "5-1.png", "6-1.png", "7-1.png"]
        }
        
        cartas = [carta1, carta2, carta3, carta4, carta5, carta6, carta7, carta8, carta9, carta10, carta11, carta12, carta13, carta14]
