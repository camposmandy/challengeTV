...
class NivelQuatroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if nomeCategoria == "Animais"{
            ...
            opcoesCarta = ["Banana.png", "Cereja.png", "Coco.png", "Laranja.png", "Limao.png", "Maca.png", "Melancia.png", "Morango.png", "Pera.png", "Banana.png", "Cereja.png", "Coco.png", "Laranja.png", "Limao.png", "Maca.png", "Melancia.png", "Morango.png", "Pera.png"]
        } else {
            opcoesCarta = ["1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png", "1-1.png", "2-1.png", "3-1.png", "4-1.png", "5-1.png", "6-1.png", "7-1.png", "8-1.png", "9-1.png"]
        }
